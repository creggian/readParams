#' readParams
#'
#' Read the parameters from command line (via commandArgs()) and return a list.
#'
#' @param default_args data.frame with four columns: variable_name, default_value, description, preprocessing_function
#' @param args the result of 'commandArgs(TRUE)'
#' @param print.input either TRUE or FALSE to show the parsed input
#'
#' @export readParams
readParams <- function(default_args, args=commandArgs(TRUE), print.input=TRUE) {
